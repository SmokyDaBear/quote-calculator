    ...
    <div className="page-container">
      ...
      <div className="page-card settings-section">
        ...
        <ul className="about-feature-list">
          ...
          <li>
            ...
            <span className="about-feature-desc">
              Save any job as a reusable template. Apply templates to new quotes with one click to speed up common services.
            </span>
          </li>
          <li>
            <span className="about-feature-title">Parts Inventory</span>
            <span className="about-feature-desc">
              Maintain a personal parts library with part numbers, names, and pricing. Pick parts directly into any job from inventory.
            </span>
          </li>
          <li>
            <span className="about-feature-title">Quote History</span>
            <span className="about-feature-desc">
              All saved quotes are indexed and searchable by customer name, quote number, or phone number. Reload, update, or delete any past quote at any time.
            </span>
          </li>
          <li>
      ...
      <div className="page-card settings-section about-privacy-card">
        ...
        <ul className="about-privacy-list">
          <li>
            <strong>Local storage only</strong> — all quotes, templates, inventory, tasks, and settings are saved in your browser's <code>localStorage</code>. Nothing is sent to any server.
          </li>
          <li>
            <strong>No account required</strong> — there is no sign-in, no registration, and no user profile of any kind.
          </li>
          <li>
            <strong>No cookies</strong> — the app sets zero cookies. No session tokens, no tracking pixels, no analytics.
          </li>
          <li>
            <strong>No third-party services</strong> — no analytics, no ads, no external API calls are made during normal use.
          </li>
          <li>
            <strong>You own your data</strong> — you can clear everything at any time from the Settings page. Closing or clearing your browser storage removes all data permanently.
          </li>
        </ul>
      </div>
    </div>
